...
export const SiteSettingsCodec = wire.object({
  ...
  site_name: wire.string,
  tagline: wire.union([wire.string, wire.null] as const),
  ...
  default_seo: wire.union([wire.serializable<SeoValue>(guard.isSeoValue, { id: "agent-cms/seo@1" }), wire.null] as const),
});
export type SiteSettings = InputOf<typeof SiteSettingsCodec>;

export const SiteSettingsCreateInput = wire.object({
  site_name: wire.string,
  tagline: wire.optional(wire.string),
  logo: wire.optional(wire.serializable<MediaValue>(guard.isMediaValue, { id: "agent-cms/media.write@1" })),
  default_seo: wire.optional(wire.serializable<SeoValue>(guard.isSeoValue, { id: "agent-cms/seo@1" })),
});
export type CreateSiteSettings = InputOf<typeof SiteSettingsCreateInput>;

export const SiteSettingsUpdateInput = wire.object({
  site_name: wire.optional(wire.union([wire.string, wire.null] as const)),
  tagline: wire.optional(wire.union([wire.string, wire.null] as const)),
  ...
  default_seo: wire.optional(wire.union([wire.serializable<SeoValue>(guard.isSeoValue, { id: "agent-cms/seo@1" }), wire.null] as const)),
});
export type UpdateSiteSettings = InputOf<typeof SiteSettingsUpdateInput>;

export const SITESETTINGS_FIELD_KEYS = ["site_name", "tagline", "logo", "default_seo"] as const;
...
export const AuthorCodec = wire.object({
  ...
  publishedAt: wire.union([wire.string, wire.null] as const),
  name: wire.string,
  bio: wire.union([wire.string, wire.null] as const),
  headshot: wire.union([wire.serializable<MediaRead>(guard.isMediaRead, { id: "agent-cms/media.read@1" }), wire.null] as const), // read: asset + canonical url · write: asset id or descriptor
});
export type Author = InputOf<typeof AuthorCodec>;

export const AuthorCreateInput = wire.object({
  name: wire.string,
  bio: wire.optional(wire.string),
  headshot: wire.optional(wire.serializable<MediaValue>(guard.isMediaValue, { id: "agent-cms/media.write@1" })),
});
...
export const AuthorUpdateInput = wire.object({
  ...
  bio: wire.optional(wire.union([wire.string, wire.null] as const)),
  headshot: wire.optional(wire.union([wire.serializable<MediaValue>(guard.isMediaValue, { id: "agent-cms/media.write@1" }), wire.null] as const)),
});
export type UpdateAuthor = InputOf<typeof AuthorUpdateInput>;

export const AUTHOR_FIELD_KEYS = ["name", "bio", "headshot"] as const;
...
export type AuthorOrderBy = "name_ASC" | "name_DESC" | "bio_ASC" | "bio_DESC" | "id_ASC" | "id_DESC" | "_status_ASC" | "_status_DESC" | "_position_ASC" | "_position_DESC" | "_createdAt_ASC" | "_createdAt_DESC" | "_updatedAt_ASC" | "_updatedAt_DESC" | "_publishedAt_ASC" | "_publishedAt_DESC" | "_firstPublishedAt_ASC" | "_firstPublishedAt_DESC";

/** Category (category) */
export const CategoryCodec = wire.object({
  id: wire.string,
  status: wire.string,
  createdAt: wire.union([wire.string, wire.null] as const),
  updatedAt: wire.union([wire.string, wire.null] as const),
  ...
  description: wire.union([wire.string, wire.null] as const),
  cover_image: wire.union([wire.serializable<MediaRead>(guard.isMediaRead, { id: "agent-cms/media.read@1" }), wire.null] as const), // read: asset + canonical url · write: asset id or descriptor
  icon: wire.union([wire.string, wire.null] as const),
  sort_order: wire.union([wire.integer(), wire.null] as const),
});
export type Category = InputOf<typeof CategoryCodec>;

export const CategoryCreateInput = wire.object({
  name: wire.string,
  slug: wire.optional(wire.string),
  description: wire.optional(wire.string),
  cover_image: wire.optional(wire.serializable<MediaValue>(guard.isMediaValue, { id: "agent-cms/media.write@1" })),
  icon: wire.optional(wire.string),
  sort_order: wire.optional(wire.integer()),
});
export type CreateCategory = InputOf<typeof CategoryCreateInput>;

export const CategoryUpdateInput = wire.object({
  name: wire.optional(wire.union([wire.string, wire.null] as const)),
  slug: wire.optional(wire.union([wire.string, wire.null] as const)),
  description: wire.optional(wire.union([wire.string, wire.null] as const)),
  cover_image: wire.optional(wire.union([wire.serializable<MediaValue>(guard.isMediaValue, { id: "agent-cms/media.write@1" }), wire.null] as const)),
  icon: wire.optional(wire.union([wire.string, wire.null] as const)),
  sort_order: wire.optional(wire.union([wire.integer(), wire.null] as const)),
});
export type UpdateCategory = InputOf<typeof CategoryUpdateInput>;

export const CATEGORY_FIELD_KEYS = ["name", "slug", "description", "cover_image", "icon", "sort_order"] as const;

export const CategoryVersionCodec = wire.serializable<VersionOf<Category>>(guard.isVersionOf, { id: "agent-cms/version.category@1" });
export const CategoryVersionListCodec = wire.array(CategoryVersionCodec);
...
export interface CategoryFilter {
  ...
  _firstPublishedAt?: DateFilter;
  _position?: NumberFilter;
  AND?: readonly CategoryFilter[];
  OR?: readonly CategoryFilter[];
}

export type CategoryOrderBy = "name_ASC" | "name_DESC" | "slug_ASC" | "slug_DESC" | "description_ASC" | "description_DESC" | "icon_ASC" | "icon_DESC" | "sort_order_ASC" | "sort_order_DESC" | "id_ASC" | "id_DESC" | "_status_ASC" | "_status_DESC" | "_position_ASC" | "_position_DESC" | "_createdAt_ASC" | "_createdAt_DESC" | "_updatedAt_ASC" | "_updatedAt_DESC" | "_publishedAt_ASC" | "_publishedAt_DESC" | "_firstPublishedAt_ASC" | "_firstPublishedAt_DESC";
...
export const PostCodec = wire.object({
  ...
  author: wire.union([wire.string, wire.null] as const), // record id → author
  category: wire.union([wire.string, wire.null] as const), // record id → category
  related_posts: wire.union([wire.array(wire.string), wire.null] as const), // record ids → post
  published_date: wire.union([wire.string, wire.null] as const), // ISO date YYYY-MM-DD
  reading_time: wire.union([wire.integer(), wire.null] as const),
  featured: wire.union([wire.boolean, wire.null] as const),
  seo_field: wire.union([wire.serializable<SeoValue>(guard.isSeoValue, { id: "agent-cms/seo@1" }), wire.null] as const),
  gallery: wire.union([wire.serializable<MediaRead[]>(guard.isMediaReadArray, { id: "agent-cms/media-gallery.read@1" }), wire.null] as const), // read: assets + canonical urls · write: asset ids or descriptors
});
...
export const PostCreateInput = wire.object({
  ...
  author: wire.optional(wire.string),
  category: wire.optional(wire.string),
  related_posts: wire.optional(wire.array(wire.string)),
  published_date: wire.optional(wire.string),
  reading_time: wire.optional(wire.integer()),
  featured: wire.optional(wire.boolean),
  seo_field: wire.optional(wire.serializable<SeoValue>(guard.isSeoValue, { id: "agent-cms/seo@1" })),
  gallery: wire.optional(wire.serializable<MediaValue[]>(guard.isMediaValueArray, { id: "agent-cms/media-gallery.write@1" })),
});
...
export const PostUpdateInput = wire.object({
  ...
  author: wire.optional(wire.union([wire.string, wire.null] as const)),
  category: wire.optional(wire.union([wire.string, wire.null] as const)),
  related_posts: wire.optional(wire.union([wire.array(wire.string), wire.null] as const)),
  published_date: wire.optional(wire.union([wire.string, wire.null] as const)),
  reading_time: wire.optional(wire.union([wire.integer(), wire.null] as const)),
  featured: wire.optional(wire.union([wire.boolean, wire.null] as const)),
  seo_field: wire.optional(wire.union([wire.serializable<SeoValue>(guard.isSeoValue, { id: "agent-cms/seo@1" }), wire.null] as const)),
  gallery: wire.optional(wire.union([wire.serializable<MediaValue[]>(guard.isMediaValueArray, { id: "agent-cms/media-gallery.write@1" }), wire.null] as const)),
});
export type UpdatePost = InputOf<typeof PostUpdateInput>;

export const POST_FIELD_KEYS = ["title", "slug", "excerpt", "cover_image", "content", "author", "category", "related_posts", "published_date", "reading_time", "featured", "seo_field", "gallery"] as const;
...
export interface PostFilter {
  ...
  author?: LinkFilter;
  category?: LinkFilter;
  related_posts?: LinksFilter;
  published_date?: DateFilter;
  reading_time?: NumberFilter;
...
export type PostOrderBy = "title_ASC" | "title_DESC" | "slug_ASC" | "slug_DESC" | "excerpt_ASC" | "excerpt_DESC" | "published_date_ASC" | "published_date_DESC" | "reading_time_ASC" | "reading_time_DESC" | "featured_ASC" | "featured_DESC" | "id_ASC" | "id_DESC" | "_status_ASC" | "_status_DESC" | "_position_ASC" | "_position_DESC" | "_createdAt_ASC" | "_createdAt_DESC" | "_updatedAt_ASC" | "_updatedAt_DESC" | "_publishedAt_ASC" | "_publishedAt_DESC" | "_firstPublishedAt_ASC" | "_firstPublishedAt_DESC";
...
export function cmsContract<C>(app: ContractFactory<C>) {
    ...
    const categoryList = app.procedure().input(wire.object({
      filter: wire.optional(wire.serializable<CategoryFilter>(guard.isFilter, { id: "agent-cms/filter.category@1" })),
      orderBy: wire.optional(wire.array(wire.serializable<CategoryOrderBy>(guard.isOrderBy, { id: "agent-cms/order-by.category@1" }))),
      page: wire.optional(PageInput),
      status: wire.optional(StatusInput),
    })).output(wire.object({ records: wire.array(CategoryCodec), total: wire.integer() }))
      .errors(pickErrors(cmsErrors, "schemaDrift")).query();
    const category = {
      list: categoryList,
      byId: app.procedure().input(IdInput).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "schemaDrift")).query(),
      search: app.procedure().input(wire.object({ q: wire.string, page: wire.optional(PageInput) })).output(PickerRowsCodec)
        .errors(pickErrors(cmsErrors, "schemaDrift")).query(),
      create: app.procedure().input(wire.object({ data: CategoryCreateInput })).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "validationFailed", "duplicate", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      update: app.procedure().input(wire.object({ id: wire.string, data: CategoryUpdateInput })).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "validationFailed", "duplicate", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      delete: app.procedure().input(IdInput).output(wire.object({ id: wire.string }))
        .errors(pickErrors(cmsErrors, "recordNotFound", "referenceConflict", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      duplicate: app.procedure().input(IdInput).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      publish: app.procedure().input(IdInput).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "validationFailed", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      unpublish: app.procedure().input(IdInput).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "validationFailed", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      publishMany: app.procedure().input(IdsInput).output(BulkResultsCodec).errors(mutationErrors).affects(categoryList).mutation(),
      unpublishMany: app.procedure().input(IdsInput).output(BulkResultsCodec).errors(mutationErrors).affects(categoryList).mutation(),
      deleteMany: app.procedure().input(IdsInput).output(BulkResultsCodec).errors(mutationErrors).affects(categoryList).mutation(),
      links: app.procedure().input(IdInput).output(BacklinksCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "schemaDrift")).query(),
      validate: app.procedure().input(wire.object({ data: wire.serializable<Partial<CreateCategory>>(guard.isRecordData, { id: "agent-cms/validate.category@1" }) })).output(ValidCodec)
        .errors(pickErrors(cmsErrors, "validationFailed", "schemaDrift")).query(),
      validateUpdate: app.procedure().input(wire.object({ id: wire.string, data: CategoryUpdateInput })).output(ValidCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "validationFailed", "schemaDrift")).query(),
      syncState: app.procedure().input(IdInput).output(SyncStateCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "schemaDrift")).query(),
      versions: {
        list: app.procedure().input(IdInput).output(CategoryVersionListCodec)
          .errors(pickErrors(cmsErrors, "recordNotFound", "schemaDrift")).query(),
        get: app.procedure().input(wire.object({ id: wire.string, versionId: wire.string })).output(CategoryVersionCodec)
          .errors(pickErrors(cmsErrors, "recordNotFound", "schemaDrift")).query(),
        restore: app.procedure().input(wire.object({ id: wire.string, versionId: wire.string })).output(CategoryCodec)
          .errors(pickErrors(cmsErrors, "recordNotFound", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      },
      schedulePublish: app.procedure().input(wire.object({ id: wire.string, at: wire.string })).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "validationFailed", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      scheduleUnpublish: app.procedure().input(wire.object({ id: wire.string, at: wire.string })).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "validationFailed", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
      clearSchedule: app.procedure().input(IdInput).output(CategoryCodec)
        .errors(pickErrors(cmsErrors, "recordNotFound", "schemaDrift")).errors(mutationErrors).affects(categoryList).mutation(),
    };
  ...
  return { siteSettings, author, category, post, assets };
}
