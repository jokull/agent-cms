-- Genesis migration: all CMS system tables.
-- Must match src/migrations.ts version 1.
...
-- Mark migration as applied so ensureSchema() skips it
INSERT OR IGNORE INTO "_cms_migrations" ("version") VALUES (1);
