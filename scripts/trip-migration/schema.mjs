  ...
  models: [
    ...
    },
    {
      ...
      fields: [
        ...
        { label: "Locations", apiKey: "locations", fieldType: "links", validators: { items_item_type: ["location"] } },
        { label: "Content", apiKey: "content", fieldType: "structured_text", localized: true, validators: { structured_text_blocks: ["image", "tour_card", "video"] } },
        { label: "SEO", apiKey: "seo", fieldType: "seo", localized: true },
        { label: "Tours", apiKey: "tours", fieldType: "links", validators: { items_item_type: ["tour"] } },
        { label: "Nearby Places", apiKey: "nearby_places", fieldType: "links", validators: { items_item_type: ["place"] } },
        { label: "Blogs", apiKey: "blogs", fieldType: "links", validators: { items_item_type: ["article"] } },
        { label: "Questions", apiKey: "questions", fieldType: "links", validators: { items_item_type: ["qa"] } },
      ],
    },
    {
      name: "Tour",
      ...
      fields: [
        ...
        { label: "Per Person", apiKey: "per_person", fieldType: "boolean" },
    ...
    },
    {
      ...
      apiKey: "qa",
      fields: [
        { label: "Question", apiKey: "question", fieldType: "string", validators: { required: true } },
        { label: "Answer", apiKey: "answer", fieldType: "text", validators: { required: true } },
      ],
    },
    {
      name: "Image",
