 ...
 */
const validateHintField = Effect.fn("validateHintField")(function* (
...
export const listModels = Effect.fn("listModels")(function* () {
 ...
 */
export const getModel = Effect.fn("getModel")(function* (id: string) {
  const sql = yield* SqlClient.SqlClient;
...
export const getModelByApiKey = Effect.fn("getModelByApiKey")(function* (apiKey: string) {
  const sql = yield* SqlClient.SqlClient;
...
export const createModel = Effect.fn("createModel")(function* (body: CreateModelInput) {
  const sql = yield* SqlClient.SqlClient;
...
export const updateModel = Effect.fn("updateModel")(function* (id: string, body: UpdateModelInput) {
  const sql = yield* SqlClient.SqlClient;
...
export const deleteModel = Effect.fn("deleteModel")(function* (id: string) {
  const sql = yield* SqlClient.SqlClient;
  const models = yield* sql.unsafe<ModelRow>("SELECT * FROM models WHERE id = ?", [id]);
  if (models.length === 0) return yield* new NotFoundError({ entity: "Model", id });
