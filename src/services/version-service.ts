 ...
 */
export const createVersion = Effect.fn("createVersion")(function* (
  modelApiKey: string,
  recordId: string,
  snapshot: string,
 ...
 */
export const listVersions = Effect.fn("listVersions")(function* (modelApiKey: string, recordId: string) {
  const sql = yield* SqlClient.SqlClient;
 ...
 */
export const getVersion = Effect.fn("getVersion")(function* (versionId: string) {
  const sql = yield* SqlClient.SqlClient;
  const rows = yield* sql.unsafe<VersionRow>(
 ...
 */
export const restoreVersion = Effect.fn("restoreVersion")(function* (modelApiKey: string, recordId: string, versionId: string, actor?: RequestActor | null) {
  const sql = yield* SqlClient.SqlClient;
 ...
 */
export const compareVersions = Effect.fn("compareVersions")(function* (modelApiKey: string, recordId: string, leftVersionId: string, rightVersionId?: string) {
  const sql = yield* SqlClient.SqlClient;
  const models = yield* sql.unsafe<ModelRow>(
    `SELECT * FROM models WHERE api_key = ?`,
    [modelApiKey]
...
export const deleteVersionsForRecord = Effect.fn("deleteVersionsForRecord")(function* (modelApiKey: string, recordId: string) {
  const sql = yield* SqlClient.SqlClient;
  yield* sql.unsafe(
